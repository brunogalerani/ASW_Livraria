...
public class CadastroProdutoEbookController implements Initializable {
	...
	private TextField textFieldCodigoBarras, textFieldPreco, textFieldTitulo, textAreaIdioma, textFieldAno,
			textFieldFormato, textFieldISBN, textFieldCategoria, textFieldNumeroPaginas, textFieldEditora,
			textFieldAutor, textFieldTamanhoArquivo, textFieldNome, textFieldQuantidade;
	...
	/*
	 * Método para "setar" os valores em um ebook e inserí-lo no banco
	 */
